...
if __name__ == "__main__":
    IN_SCEN = "/home/rdaneel/mapf_benchmark/scen-even/warehouse-10-20-10-2-1-even-1.scen"
    IN_PATH = "/home/rdaneel/FEECBS_HWY/local/result_path.txt"
    OUT_PATH = "/home/rdaneel/MAPF_analysis/local/result_path.json"
    path_trans = PathsTransfer(IN_SCEN, IN_PATH)
    path_trans.read_path(IN_PATH)
    path_trans.write_to_json(OUT_PATH)
